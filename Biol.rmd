...
To answer this question you should use the dataset CAR_EMISSION.CSV, 
...
```
#### Question 8: 
A persons body mass index (BMI) is calculated by dividing their weight #(measured in kg) by the square of their height (measured in metres). It has 
...
#### Question 10: 
You are asked to analyse whether the rate of brow surgeries (quantified as number 
