...
```
 ...
 answer: We find evidence of a relationship between a persons BMI and their age (F1,248=4.2, p=0.042). The relationship between BMI (kg m-2) and age (years) is estimated to be BMI-1 = 0.043 - 0.000052 age.
