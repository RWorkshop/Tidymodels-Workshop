...
In fact users can even perform analyses based on specified hypotheses with the <tt>hypothesize()</tt> function.
...
```{r} 
soda_ounces <-as_tibble(soda_ounces) soda_ounces
...
point - this option should be used when there is one variable in the hypothesis, such as “the mean of this data x”.

independence - this option should be used when there are two populations, such as " the means of these two groups identical" or “this variable influences this other variable”.
...
prop for proportion for categorical variables
